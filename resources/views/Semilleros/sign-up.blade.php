        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div class="card z-index-0">
                    <div class="card-body">
                        <form  action="{{route('crearusuario',$s->id_semillerista)}}" method="POST" role="form text-left">
                            @csrf
                            <div class="mb-3">
                                <label>{{ __('Nombre') }}</label>
                                <div class="@error('name') border border-danger rounded-3  @enderror">
                                    <input type="text" class="form-control" placeholder="Name" 
                                        aria-label="Name" aria-describedby="email-addon" id="name" value='{{$s->nom_semillerista}}'>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="@error('ced') border border-danger rounded-3  @enderror" >
                                    <input wire:model="ced" type="text" class="form-control" placeholder="Cedula"
                                        aria-label="ced" aria-describedby="email-addon" id="ced" value='{{$s->id_semillerista}}'>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="@error('email') border border-danger rounded-3 @enderror">
                                    <input wire:model="email" type="email" class="form-control" placeholder="Email" 
                                        aria-label="Email" aria-describedby="email-addon" id="email" value='{{$s->correo_semillerista}}'>
                                </div>
