        ...
        <div class="row gx-4">
            <div class="col-auto">
                <div class="avatar avatar-xl position-relative">
                    <img src="{{$dirlogo}}" alt="..." class="w-130 border-radius-lg shadow-sm">
                </div>
            </div>
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">
                    {{ $semillero->nom_semillero}}
                    </h5>
            ...
            <div class="col-lg-6 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 active {{ Route::currentRouteName() == 'miSemillero' ? 'active' : '' }}" href="{{route('miSemillero',$semillero->id_semillero)}}">
                                ...
                                <span class="ms-1">Información</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1  {{ Route::currentRouteName() == 'semilleristas' ? 'active' : '' }}" 
                                href="{{route('semilleristas',$semillero->id_semillero)}}" >
                                ...
                                <span class="ms-1">Semilleristas</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 {{ Route::currentRouteName() == 'miSemillero' ? 'active' : '' }}" href="{{route('miSemillero',$semillero->id_semillero)}}">
                                ...
                                <span class="ms-1">Proyectos</span>
                            </a>
                        </li>
                    </ul>
                </div>
